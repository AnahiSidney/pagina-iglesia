		...
		<div class="tab-content" id="myTabContent">
						...
						<div class="table-responsive">
							<table id="userList" class="table table-bordered table-hover table-striped">
                            	...
                            	<!-- aqui van los datos de la bd lon nombre de los campos -->
                                	...
                                	<a href="../controladores/ministerio/edit_mini.php?id=<?php echo $row['id']?>">
                                    	<i class="fas fa-edit"></i>
                                	</a> |
                                	<a href="../controladores/ministerio/delete_mini.php?id=<?php echo $row['id']?>">
			...
			<div class="tab-pane fade" id="form" role="tabpanel" aria-labelledby="form-tab">
				<div class="card">
					...
					<div class="card-header">
						<h4>Informacion de ministerios</h4>
					</div>
					<div class="card-body">
						<form action="../controladores/ministerio/save_mini.php" method="post" enctype="multipart/form-data" class="form" role="form" autocomplete="off">
							<div class="form-group row">
								<label class="col-lg-3 col-form-label form-control-label">Ministerio</label>
								<div class="col-lg-9">
							...
							<div class="form-group row">
                                ...
                                <input type="submit" class="btn btn-success btn-block" name="bg_ministerio" value="Registrar Ministerio">
						    </div>
