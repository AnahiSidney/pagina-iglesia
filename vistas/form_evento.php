		...
		<div class="tab-content" id="myTabContent">
						...
						<div class="table-responsive">
							<table id="userList" class="table table-bordered table-hover table-striped">
                            	...
                            	<!-- aqui van los datos de la bd lon nombre de los campos -->
									...
									<td><?php echo $row['id_direc']?></td>
                           	 		<td><?php echo $row['id_usu']?></td>
							                    
									<td>
								
                                	<a href="../controladores/evento/edit_eve.php?id=<?php echo $row['id']?>">
                                    	<i class="fas fa-edit"></i>
                                	</a> |
                                	<a href="../controladores/evento/delete_eve.php?id=<?php echo $row['id']?>">
			...
			<div class="tab-pane fade" id="form" role="tabpanel" aria-labelledby="form-tab">
				<div class="card">
					...
					<div class="card-header">
						<h4>Informacion de eventos</h4>
					</div>
					<div class="card-body">
						<form action="../controladores/evento/save_eve.php" method="post" enctype="multipart/form-data" class="form" role="form" autocomplete="off">
							<div class="form-group row">
								<label class="col-lg-3 col-form-label form-control-label"> Evento</label>
								<div class="col-lg-9">
									<input class="form-control" type="text" name="f_titulo">
								</div>
							</div>
							<div class="form-group row">
								<label class="col-lg-3 col-form-label form-control-label"> Fecha</label>
								<div class="col-lg-9">
									<input class="form-control" type="date" name="f_fecha">
								</div>
							</div>
							<div class="form-group row">
								<label class="col-lg-3 col-form-label form-control-label"> Hora</label>
								<div class="col-lg-9">
									<input class="form-control" type="time" name="f_hora">
								</div>
							</div>
							<div class="form-group row">
							...
							<div class="form-group row">
								...
								<?php
                                    ...
                                    $result = mysqli_query($conn, $query);?>
                                    <select  class="form-control" name="f_id_directiva"  placeholder="seleccione ministerio">
                                    <?php
                                    while($row = mysqli_fetch_array($result)){?>
							...
							<div class="form-group row">
								...
								<?php
                                    ...
                                    $result = mysqli_query($conn, $query);?>
                                    <select  class="form-control" name="f_id_usuario"  placeholder="seleccione ministerio">
                                    <?php
                                    while($row = mysqli_fetch_array($result)){?>
							...
							<div class="form-group row">
                                ...
                                <input type="submit" class="btn btn-success btn-block" name="bg_evento" value="Registrar Evento">
						    </div>
						</form>
					</div>
				</div>
