...
if (isset($_POST['bg_directiva'])){
   ...
   $query = "INSERT INTO directiva(nombre,apellido,imagen,descripcion,cargo,gestion,celular,id_usu) 
             VALUES ('$nombre','$apellido','$imagen','$descripcion','$cargo','$gestion','$celular','$id_usuario')";
