...
// lo que hace es trae la tupla de un reglon de latabla de la bd
    ...
    if (isset($_POST['fb_actualizar'])) {
        ...
        $query = "UPDATE ministerio set titulo = '$titulo', imagen = '$imagen', 
                    descripcion = '$descripcion', id_usu = '$id_usuario' WHERE id = $id";
...
<!--  -->
            <div class="card">
                ...
                <div class="card-header">
                    <h4>Informacion de ministerio</h4>
                </div>
                <div class="card-body">
                    <form action="edit_mini.php?id=<?php echo $_GET['id'];?>"  method="POST" enctype="multipart/form-data" class="form" role="form" autocomplete="off">
